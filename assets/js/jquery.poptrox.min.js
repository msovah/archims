/* jquery.poptrox.js v2.5.2-dev | (c) @ajlkn | github.com/ajlkn/jquery.poptrox | MIT licensed */ ! function(e) {
    e.fn.poptrox_disableSelection = function() {
        ...
        return l.on("resize orientationchange", function() {
            ...
            var e = d + 1;
            // Jeśli e >= u.length, oznacza to, że próbujemy przejść za ostatni element
            if (e >= u.length) {
                x.trigger("poptrox_close"); // Zamknij Poptrox
                return; // Zakończ funkcję, nie wywołuj switcha
            }
            x.trigger("poptrox_switch", [e])
        }).on("poptrox_previous", function() {
            var e = d - 1;
            // Jeśli e < 0, oznacza to, że próbujemy przejść przed pierwszy element
            if (e < 0) {
                x.trigger("poptrox_close"); // Zamknij Poptrox
                return; // Zakończ funkcję, nie wywołuj switcha
            } 
            ...
            if ("ignore" != n && i.attr("href")) {
                ...
                switch (p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
                    ...
                    case "bcove":
                        ...
                        break;
                    default:
                        t.object = e('<img src="' + t.src + '" alt="" style="max-width: 100%; height: auto; vertical-align:bottom;" />');
                        if (s.preload) {
